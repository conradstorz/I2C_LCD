...
class lcd:
   ...
   def lcd_write_char(self, charvalue, mode=1):   # write a character to lcd (or character rom) 0x09: backlight | RS=DR<
      self.lcd_write_four_bits(mode | (charvalue & 0xF0))
      self.lcd_write_four_bits(mode | ((charvalue << 4) & 0xF0))
      # works!  

   def lcd_display_string(self, string, line):   # put string function
      line_addr = [0x00, 0x80, 0xC0, 0x94, 0xD4] # index position zero is a dummy never used
